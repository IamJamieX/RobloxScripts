...
for _,gamepart in ipairs(parts) do
    if (gamepart:IsA("BasePart")) then
        if gamepart.Name == "Anchor" then
		    if gamepart.Parent.Name == "Purple" then
			    print("Purple Lootbag was found")
...
NotFoundTextLabel.Text = "No Purple Loot Detected!"
...
FoundTextLabel.Text = "Purple Loot Detected!"
